...
多數 SDLC 工具把最佳實踐當作必須遵守的規則。這組技能把它們當作**可以選用的工具** — 有意識地、根據當下情境來選擇。

這個區別來自實戰。在職涯早期大量閱讀軟體工程、資料庫、系統架構的最佳實踐，然後在大大小小的專案中反覆套用 — 有時候取得成功，有時候卻反而製造了混亂，甚至為日後埋下麻煩。經過反覆嘗試和從中汲取教訓，一個模式浮現了：**同樣的設計，在不同的時空背景下，會有不同的、屬於當下最適合的選擇。**決定因素可能是團隊成員的經驗和技能組合、基礎設施的完善程度、組織策略、商業目標、上線時程、利害關係人的期待 — 重點不是你有沒有套用 DDD 或 Clean Architecture，而是這個選擇是不是**有意識的**。

這組技能就是基於這個信念來設計的：

**有框架，但不教條。**每個階段提供結構 — 用戶故事、架構圖、測試計畫、上線清單 — 但深度和正式程度會根據情境調整。一個 5 人使用的內部工具和一個服務百萬用戶的支付系統，都經過相同的關卡，但嚴謹度天差地別。技能會先了解你的狀況，再校準產出。

**有意識的取捨，而非無意識的省略。**當技能建議推遲某些工作 — 跳過完整 PRD、簡化架構、縮減測試範圍 — 它會明確點名這個取捨：你換到了什麼、放棄了什麼、什麼條件改變時需要重新評估。有意識地承擔技術債，基於充分了解全貌後做出的選擇，是智慧。沒有經過思考就便宜行事，只是債務。

**避免過早抽象，但要去思考。**現在不做抽象，不代表不去想抽象。而是你已經思考過未來可能的走向，有意識地判斷在這個階段做抽象會限縮未來發展多過於帶來好處。技能會記錄考慮過什麼、為什麼推遲 — 這樣當情境改變時，這個決策可以被重新檢視。

**程式碼是流動的。**它服務於一個會演化的專案概念 — 改變、刪減、成長。這組技能為這種流動性而設計：結構可以隨之改變形狀而不需要昂貴的重寫，但也不會為了可能永遠不會到來的未來而過度設計彈性。三個具體的實作，比一個過早的抽象介面教你更多關於正確抽象的事情。

**區分原則性的和可調整的。**有些事情是不可妥協的原則（可測試的驗收標準、正式環境的回滾計畫）。有些可以隨情境彈性調整（要不要用 DDD、架構分幾層、簽核要多正式）。技能會標明哪些是哪些 — 讓你在該堅持的地方堅持，該靈活的地方靈活。

目標不是產出最多的文件、套用最多的模式。而是幫助你**看見全貌，然後做出有意識的選擇** — 帶著從實作中學來的工程智慧，而不只是從書本上讀來的知識。
